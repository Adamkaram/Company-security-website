...
class Email extends React.Component {
  ...
  ClickHandler = () => {
    ReactGA.event({
      category: "Button",
      action: "Click the button from Message submit",
    });
    alert(
  ...
  handleSubmit(e) {
    e.preventDefault();
    axios.post("http://localhost:5000/send", this.state).then((response) => {
          ...
          <div className="max-width">
            ...
            <div className="contact-content">
              <div className="column left">
                ...
                <p>
                  Are you ready to manage all the cyber security challenges by
                  yourself? Contact us now and we will explain you how we can
                  help your company to prevent data breaches and be protected
                  against any threat.
                </p>
                <div className="icons">
                  <div className="row">
                    ...
                    <div className="info">
                      ...
                      <div className="sub-title">LorienSec</div>
                    </div>
                  </div>
                  <div className="row">
                    ...
                    <div className="info">
                      ...
                      <div className="sub-title">Egypt , Cairo</div>
                    </div>
                  </div>
                  <div className="row">
              ...
              <div className="column right">
                ...
                <div className="text">
                  ...
                  questions.We will contact you shortly
                </div>
                ...
                <div class="middle">
                  <a class="btn" href="https://github.com/umarcbs">
                    <i class="fab fa-github"></i>
                  </a>
                  <a class="btn" href="https://twitter.com/umarcbs">
